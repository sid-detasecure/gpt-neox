...
RUN apt-get update -y && \
    apt-get install -y \
        ...
        rdmacm-utils perftest rdma-core nano git-lfs && \
...
#### Python packages
RUN pip3 install torch --extra-index-url https://download.pytorch.org/whl/cu113 && pip cache purge
...
USER peter
WORKDIR /home/peter
RUN mkdir /home/peter/gpt-neox 
COPY . /home/peter/gpt-neox